...
# Keep this alias importable on the project's supported Python 3.8 runtime.
# Parameterized built-in collections are evaluated here (outside an
# annotation), while ``dict[...]``/``list[...]`` are only available from 3.9.
